...
// Keep this structure in sync with the i2c-slave example.
struct MESSAGE_DATA
{
   uint8_t sequence;
   uint16_t crc16;
...
uint16_t RobotMasterI2C2::calculateCRC16(uint8_t *data, size_t length)
   {
      crc.clearCrc();
...
MESSAGE_DATA RobotMasterI2C2::encodeMessage(String bytes)
{
...
MESSAGE_DATA RobotMasterI2C2::validateMessage(char *bytes_message)
{
...
void RobotMasterI2C2::sendMessage(int seq, String msg)
{
...
void  RobotMasterI2C2::receiveEvent(int howMany)
{
